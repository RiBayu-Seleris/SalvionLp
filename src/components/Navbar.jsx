...
function MenuNav({ isScrolled }) {
  ...
  const plainLinkClass = `cursor-pointer text-[12pt] lg:text-[10pt] xl:text-[12pt] font-[500]`;
  ...
  return (
    ...
    >
      ...
      <li>
        <Navlink className={plainLinkClass} href="/developer">
          Developer
        </Navlink>
      </li>

      <li>
        <Navlink className={plainLinkClass} href="/insight">
          Insight
        </Navlink>
      </li>

      <li>
        <Navlink className={plainLinkClass} href="/company">
          Company
        </Navlink>
      </li>
